{
  description = "cloudflare-dns-terraform - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 cloudflare-dns-terraform development environment"
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          pname = "cloudflare-dns-terraform";
          version = "0.1.0";
          src = ./.;
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P cloudflare-dns-terraform.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/cloudflare-dns-terraform $out/bin/  # Rust
            # cp bin/cloudflare-dns-terraform $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/cloudflare-dns-terraform";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-cloudflare-dns-terraform" {
