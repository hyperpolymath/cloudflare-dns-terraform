...
# Justfile for cloudflare-dns-terraform
...
doctor:
    @echo "Running diagnostics for cloudflare-dns-terraform..."
...
tour:
    @echo "=== cloudflare-dns-terraform Tour ==="
    @echo ""
...
help-me:
    @echo "=== cloudflare-dns-terraform Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/cloudflare-dns-terraform/issues/new"
    @echo ""
...
# LLM context dump
llm-context:
    @echo "Project: cloudflare-dns-terraform"
